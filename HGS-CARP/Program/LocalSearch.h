...
private:
	...
	void computeCoutInsertion(Node* clients, int Pattern); // subprocedures for PI
...
public:
	...
	void insertNoeud(Node* U, Node* V); // Inserts clients U after V
	void removeNoeud(Node* U); // Removes clients U
	void addNoeud(Node* U, Node* V); // Adds clients U after V
