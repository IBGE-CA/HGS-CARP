...
public:
	...
	std::vector<std::vector<std::vector<std::pair<int, int>>>> bestCostArcs;
	...
	double evaluation(std::vector<SeqData*> seqs, Vehicle* vehicle);
	...
	double evaluationLB(std::vector<SeqData*> seqs, Vehicle* vehicle);
