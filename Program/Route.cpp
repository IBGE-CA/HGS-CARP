...
Route::Route(int cour, Noeud* depot, Vehicle* vehicle, Params* params, Individual* indiv, int day) : params(params), individu(indiv), cour(cour), day(day), depot(depot), vehicle(vehicle)
{
